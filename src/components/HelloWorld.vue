<template>
  <div>
  <h1 id="idh1"></h1>
 <!-- <img id="id2" src="../assets/logo.png"> -->
  ...
  <div id="create"></div>
  <input type="number" id="name" name="name" size="10">
...
export default {
  ...
  methods: {
    ...
    create: function () {
      axios
      .get('https://pokeapi.co/api/v2/pokemon/'+document.getElementById("name").value)
      .then(response => {
      ...
      // var txt = JSON.stringify(this.info)
